...
export default function Portfolio() {
  ...
  return (
    <div className="relative bg-zinc-900 text-zinc-100 min-h-screen font-sans selection:bg-emerald-500/30 overflow-x-hidden">
      ...
      {/* HERO SECTION */}
      <section id="home" className="min-h-screen flex flex-col items-center justify-center relative overflow-hidden bg-gradient-to-b from-zinc-900 via-zinc-800 to-zinc-900 text-center px-4">
      ...
      {/* FOOTER */}
      <footer className="relative py-12 text-center overflow-hidden bg-zinc-900 border-t border-zinc-800">
        <div className="absolute inset-0 bg-[linear-gradient(to_right,#80808012_1px,transparent_1px),linear-gradient(to_bottom,#80808012_1px,transparent_1px)] bg-[size:32px_32px]" />
